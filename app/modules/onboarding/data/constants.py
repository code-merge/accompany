...
steps = [
    ...
    {"icon": load_svg(ICON_DIR / "system_setup.svg"), "title": "onboarding_system_setup", "description": "onboarding_system_setup_desc"},
    {"icon": load_svg(ICON_DIR / "finish.svg"), "title": "onboarding_finish", "description": "onboarding_finish_desc"}
]
